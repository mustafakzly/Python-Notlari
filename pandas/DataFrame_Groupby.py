...
import numpy as np
personeller = {
    'Çalışan':['Ahmet Yılmaz','Can Ertürk','Hasan Korkmaz','Cenk Saymaz','Ali Turan'],
    'Departman':['İnsan Kaynakları','Bilgi İşlem','Muhasebe','İnsan Kaynakları','Bilgi İşlem'],
    'Yaş':['30','25','45','50','23'],
    'Semt':['Kadıköy','Tuzla','Maltepe','Tuzla','Kadıköy'],
    'Maaş':[5000,3000,4000,3500,2750]
